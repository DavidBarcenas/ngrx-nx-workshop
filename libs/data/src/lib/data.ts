...
export const data: Product[] = [
  ...
  },
  {
    ...
    price: 125.0,
    title: 'Speakers',
    url: '/assets/electronics/electronic-1.jpg',
    description:
      // tslint:disable-next-line:max-line-length
  ...
  },
  {
    ...
    price: 1125.0,
    title: 'Quadcopter',
    url: '/assets/electronics/electronic-2.jpg',
    description:
      // tslint:disable-next-line:max-line-length
  ...
  },
  {
    ...
    price: 125.0,
    title: 'Camera',
    url: '/assets/electronics/electronic-3.jpg',
    description:
      // tslint:disable-next-line:max-line-length
